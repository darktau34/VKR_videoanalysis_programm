...
"}")
    ...
    def start_analyze(self):
        ...
        app_analyze(self.video_path, self.appear_time, self.progress_bar)
    ...
    def show_analysis(self):
        ...
        self.ui_analyze_window.setupUi(self.form)
        self.ui_analyze_window.my_setup(self.video_id, self.cur_video)
        self.form.show()

    def currentRowChanged_handler(self):
        if self.list_view.currentRow() != -1:
