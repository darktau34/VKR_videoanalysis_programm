...
DATE_FORMAT = '%H:%M:%S'
logging.basicConfig(level=logging.INFO, format=LOG_FORMAT, datefmt=DATE_FORMAT, filename='logs.log', filemode='w')
...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        self.list_view.viewport().setProperty("cursor", QtGui.QCursor(QtCore.Qt.ArrowType))
