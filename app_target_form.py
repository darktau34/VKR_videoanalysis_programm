...
class Ui_TargetForm(object):
    ...
    def setupUi(self, MainWindow):
        ...
        MainWindow.setGeometry(450, 250, 501, 211)
        MainWindow.setFixedWidth(501)
...
"")
        ...
        self.list_emotions.setGeometry(QtCore.QRect(10, 70, 221, 41))
        font = QtGui.QFont()
        font.setBold(True)
        ...
        self.frame_2.setGeometry(QtCore.QRect(250, 0, 251, 151))
        font = QtGui.QFont()
...
"")
        ...
        self.list_items.setGeometry(QtCore.QRect(20, 70, 221, 41))
        font = QtGui.QFont()
        font.setBold(True)
        font.setKerning(True)
        font.setStyleStrategy(QtGui.QFont.StyleStrategy.PreferDefault)
        ...
        self.btn_analyze.setGeometry(QtCore.QRect(0, 150, 501, 61))
        palette = QtGui.QPalette()
...
"}")
    ...
    def show_analyze(self):
        ...
        self.ui_target_main = Ui_TargetMain(self.item_index, self.emotion_index, self.video_id, self.video_path)
        self.ui_target_main.setupUi(self.target_main)
        if self.ui_target_main.need_show:
